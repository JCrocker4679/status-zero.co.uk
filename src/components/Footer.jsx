...
export function Footer() {
  return (
    <footer className="border-t border-slate-400/10 bg-white">
      <Container>
        <div className="py-12">
        ...
        <div className="flex flex-col items-center border-t border-slate-400/10 py-10 sm:flex-row-reverse sm:justify-between">
          <div className="flex gap-x-6">
            <Link
              ...
              className="group"
              aria-label="Status Zero on LinkedIn"
            >
              <svg
                aria-hidden="true"
          ...
          <p className="mt-6 text-sm text-slate-500 sm:mt-0">
            Copyright &copy; {new Date().getFullYear()} Status Zero. All rights
            reserved. Status Zero is a trading name of JC Media and Technology
            ltd.
          </p>
        </div>
      </Container>
